                  ...
                  <div class="calloremail mt-3 float-lg-end">
                    <ul class="list-unstyled">
                       <li class="mb-2">
                          ...
                          <p class="footer-text-p"><span class="w-400" style="background: #1c1c1c;color: #fff;border-radius: 50%;padding: 2px 5px;font-family: 'Roboto', sans-serif;"><i class="fa-solid fa-phone"></i></span> <a href="tel:{{ isset($setting->phone) ? $setting->phone : '' }}">{{ isset($setting->phone) ? $setting->phone : '' }}</a></p>
                       </li>
                       <li class="mb-2">
                          <p class="footer-text-p"><span class="" style="background: #1c1c1c;color: #fff;border-radius: 50%;padding: 2px 5px;font-family: 'Roboto', sans-serif;"><i class="fa-regular fa-envelope"></i></span> <a href="mailto:{{ isset($setting->email) ? $setting->email : '' }}">{{ isset($setting->email) ? $setting->email : '' }}</a></p>
                       </li>
                       <li class="mb-2">
